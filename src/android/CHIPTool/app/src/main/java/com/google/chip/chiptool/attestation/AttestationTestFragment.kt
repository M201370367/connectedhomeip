...
class AttestationTestFragment : Fragment() {
  ...
  override fun onCreateView(
    ...
    binding.attestationText.text = requireContext().getString(R.string.attestation_fetching_status)
    ...
    if (appIntent != null) {
      ...
      binding.attestationText.text = requireContext().getString(R.string.attestation_app_not_found)
    }
